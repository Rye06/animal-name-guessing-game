...
blank = petName
numBlanks = random.randint(1, len(petName)-2) # Randomly generates the number of blanks
...
for i in range(0, numBlanks, 1):
    ...
    while chk:
        ...
        if(blank[blankInd] == "_"):
            ...
            blank = blank[:blankInd] + "_" + blank[blankInd + 1:] # Replaces the letter at the randomly generated index with a "_" in the blanked word
            chk = False

# Blank word is generated by the end of the loop (here)
